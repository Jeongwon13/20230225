// id로 접근하기
function fnTest1() {
    // id가 "div"인 요소를 얻어와 상수형 변수 div1에 저장
    const div1 = document.getElementById("div1");

    // 접근할 요소의 배경색을 얻어와 변수(bgColor)에 저장
...
function fnTest4() {
        ...
        // input 관련 태그에 작성된 값 나타내는 속성 == value
        // 아이디 중복확인 같은데 쓸 듯
        alert(input.value);
...
// name 속성으로 접근하기
function fnTest5() {
    // name 속성 값에 "hobby"인 요소를 모두 얻어와 배열 형식으로 변환
...
function readValue() { // 입력된 창을 읽어들여 채팅창에 출력
    // 채팅과 관련된 요소 모두 얻어오기
